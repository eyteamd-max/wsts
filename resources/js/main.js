(function () {
    ...
    var announcementConfirm = document.getElementById('announcementConfirm');
    var announcementShown = false;

    function showAnnouncement() {
        if (!announcementOverlay || announcementShown) return;
    ...
    if (announcementConfirm) {
        announcementConfirm.addEventListener('click', hideAnnouncement);
    }
    if (announcementOverlay) {
        announcementOverlay.addEventListener('click', function (e) {
            if (e.target === announcementOverlay) hideAnnouncement();
        });
    }
